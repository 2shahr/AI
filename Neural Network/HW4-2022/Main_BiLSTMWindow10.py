...
def  DoingSlidingWindow(sample, annotation, X_temp, y_temp, WindowLenth):
    ...
    for it in np.arange(0, sample1.shape[0]-WindowLenth+1, WindowLenth):
        temp = []
    ...
    for it in np.arange(0, sample2.shape[0]-WindowLenth+1, WindowLenth):
        temp = []
    ...
    for it in np.arange(0, sample3.shape[0]-WindowLenth+1, WindowLenth):
        temp = []
