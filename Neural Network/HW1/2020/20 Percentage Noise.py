# -*- coding: utf-8 -*-
"""
Created on Thu Apr  9 00:29:57 2020
...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  9 00:05:17 2020
...
np.random.seed(0)
indices1 = np.random.choice(np.arange(10000),
                            size = 2000,
                            replace = False)

for j in range(60):
    for i in range(indices1.size):
        X_test[indices1[i], j] = -X_test[indices1[i], j]
