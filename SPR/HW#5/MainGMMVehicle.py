...
# Load data
Raw_data = pd.read_csv('vehicle_data.data')
Inputs = Raw_data.values[:, 0:-2]
Targets = Raw_data.values[:, -2]
Targets[Targets == 'van'] = 0
Targets[Targets == 'saab'] = 1
Targets[Targets == 'bus'] = 2
Targets[Targets == 'opel'] = 3
